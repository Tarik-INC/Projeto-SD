...
def new_transaction():
    ...
    response = {'message': f'A trasação será adicionada ao bloco {index}'}
...
def register_nodes():
    ...
    if nodes is None:
       return "Erro: Por favor, entre com um lista válida de nós", 400
...
def consensus():
    ...
    if replaced:
        response = {
            'message': 'Nossa blockchain foi substituída',
